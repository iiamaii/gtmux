...
gtmux layout show|hide|minimize|restore <target>
...
gtmux layout create <type> [--x --y --w --h] [--set ...|--json ...]   # text/note/rect/ellipse/line/free_draw/image/document/file_path/snippets/caption/path
