...
| `text` | `text: string`, `font_size: number`, `text_align?: "left" \| "center" \| "right"` (**G39 amend, 누락 시 `"center"`), `text_vertical_align?: "top" \| "middle" \| "bottom"` (**G40 amend, 누락 시 `"middle"`), `color: string` |
| `note` | `title: string`, `body: string`, `color: string` |
| `rect` | `stroke: string`, `fill: string`, `stroke_width: number` |
| `ellipse` | `stroke: string`, `fill: string`, `stroke_width: number` |
| `line` | `stroke: string`, `stroke_width: number`, `x2: number`, `y2: number` |
